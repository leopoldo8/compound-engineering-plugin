...
Task({
  ...
  subagent_type: "ce-security-sentinel",
...
// Security review
Task({
  subagent_type: "review:ce-security-sentinel",
...
// Performance review
Task({
  subagent_type: "review:ce-performance-oracle",
...
// Rails code review
Task({
  subagent_type: "review:ce-kieran-rails-reviewer",
...
// Architecture review
Task({
  subagent_type: "review:ce-architecture-strategist",
...
// Code simplicity
Task({
  subagent_type: "review:ce-code-simplicity-reviewer",
...
- `ce-agent-native-reviewer` - Ensures features work for agents too
- `ce-architecture-strategist` - Architectural compliance
- `ce-code-simplicity-reviewer` - YAGNI and minimalism
- `ce-data-integrity-guardian` - Database and data safety
- `ce-data-migration-expert` - Migration validation
- `ce-deployment-verification-agent` - Pre-deploy checklists
- `ce-dhh-rails-reviewer` - DHH/37signals Rails style
- `ce-julik-frontend-races-reviewer` - JavaScript race conditions
- `ce-kieran-python-reviewer` - Python best practices
- `ce-kieran-rails-reviewer` - Rails best practices
- `ce-kieran-typescript-reviewer` - TypeScript best practices
- `ce-pattern-recognition-specialist` - Design patterns and anti-patterns
- `ce-performance-oracle` - Performance analysis
- `ce-security-sentinel` - Security vulnerabilities

### Research Agents
```javascript
// Best practices research
Task({
  subagent_type: "research:ce-best-practices-researcher",
...
Task({
  subagent_type: "research:ce-framework-docs-researcher",
...
Task({
  subagent_type: "research:ce-git-history-analyzer",
...
**All research agents:**
- `ce-best-practices-researcher` - External best practices
- `ce-framework-docs-researcher` - Framework documentation
- `ce-git-history-analyzer` - Code archaeology
- `ce-learnings-researcher` - Search docs/solutions/
- `ce-repo-research-analyst` - Repository patterns

### Design Agents
```javascript
Task({
  subagent_type: "design:ce-figma-design-sync",
...
```javascript
Task({
  subagent_type: "workflow:ce-bug-reproduction-validator",
